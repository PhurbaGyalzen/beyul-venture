...
const datas = [
    {
        ...
        content:
            'As per the company policy, you can book your trip paying as little as 20% non-refundable deposits upfront to secure your trip. And you can pay rest of the amount when you arrive to our office in Kathmandu before the trip departure.',
    },
...

    {
        ...
        content:
            'To promote our business, we need to improve our official site. Therefore, some of your information is assessed by the google analytics to obtain the detail of our web traffic. The information like page viewed, location, date and time can be assessed easily.',
    },

    {
        ...
        content:
            'We use cookies which helps us to know that you are our visitor who had visited us previously. When you browse us the second time, the technology popularly known as cookies recognizes your browser and helps us know that your browser had visited our site. The links on our website',
    },

    {
        ...
        content:
            ' We reserve our right to amend or update our privacy policy if necessary. The privacy policy is subject to change as per the circumstances. If you have any queries regarding our privacy policy, you can mail us your queries at our company’s office mailing address or privacy@beyulventure.com',
    },
...

    {
        ...
        content:
            'You should present all the necessary documents like Passport, visas, permits, etc. You will be held accountable in case you cannot make trips due to the absence of essential papers and documents.',
    },
                    ...
                    <Grid container>
                        <Grid item>
                            <Typography variant='body2'>
                                ...
                                We need your information to arrange a smooth
                                and effective trip for you in Nepal, Tibet or
                                Bhutan. However, we value the privacy of our
                                esteemed customers. Any kind of misuse of
                                information or handing over your information to
                                others is highly discouraged. We appreciate the
                                fact that you hand over your confidential
                                information to us with trust and ensure you to
                                reciprocate the same in future.
                            </Typography>
                        </Grid>
                    </Grid>
                </Box>
