        ...
        <TwoColGrid>
            ...
            <div style={{ padding: '10%' }}>
                ...
                <div>
                    ...
                    <ul>
                        <TickedList>
                            Lorem ipsum donot eyy donot luike
                        </TickedList>
                        <TickedList>
                            {' '}
                            Lorem ipsum donot eyy donot luike
                ...
                <Enquiry>
                    <BlueBtn href='/package/1?paymentResp=fail'>
                        Ask a question
                    </BlueBtn>
                    <GreenBtn
                        href={getEsewaLink(100, Math.random().toString())}
                    >
                        Book this tour
                    </GreenBtn>
                    <Link to='/stripe-payment/1'>Pay with stripe</Link>
                </Enquiry>
            </div>
        </TwoColGrid>
    )
