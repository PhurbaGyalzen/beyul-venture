...
const datas = [
...

    {
        ...
        description:
            'All bookings are made with  Beyul Venture Pvt. Ltd. based at Boudha, Kathmandu, Nepal. Trip is reference to as Company in booking conditions. To book your holiday you need to send us completed booking (inquiry) form or directly email us with details.',
    },
]
        ...
        <>
            <div className={classes.root}>
                ...
                {data.map((currElement) => {
                    return <UsefulInfo key={currElement.id} {...currElement} />
                })}
            </div>
        </>
    )
