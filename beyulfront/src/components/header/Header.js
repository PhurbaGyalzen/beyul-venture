      ...
      <AppBar position="fixed" className={classes[navRef.current]}>
        <Toolbar disableGutters>
          ...
          <div className={classes.sectionDesktop}>
            <NavBtn
              to='/' className={classes[navRef1.current]} component={NavLink}>HOME</NavBtn>
            <NavBtn disableElevation to='/about' className={classes[navRef1.current]} component={NavLink}>ABOUT</NavBtn>
            <NavBtn to='/blog' className={classes[navRef1.current]} component={NavLink}>BLOG</NavBtn>
            <NavBtn to='/contact-us' className={classes[navRef1.current]} component={NavLink}>CONTACT</NavBtn>
            <NavBtn to='/our-team' className={classes[navRef1.current]} component={NavLink}>TEAM</NavBtn>
            <NavBtn to='/sign-in' className={classes[navRef1.current]} component={NavLink}>LOGIN</NavBtn>
